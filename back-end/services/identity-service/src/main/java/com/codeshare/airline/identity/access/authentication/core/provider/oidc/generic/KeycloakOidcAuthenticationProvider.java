...
@Component
public class KeycloakOidcAuthenticationProvider extends AbstractOidcAuthenticationProvider {

    public KeycloakOidcAuthenticationProvider(
    ...
    protected AuthenticationResult mapToAuthResult(
        ...
        return AuthenticationResult.builder()
                ...
                .authSource(AuthSource.KEYCLOAK)
                .build();
    }
}
