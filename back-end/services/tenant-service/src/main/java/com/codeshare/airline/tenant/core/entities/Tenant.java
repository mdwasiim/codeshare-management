package com.codeshare.airline.tenant.core.entities;
...
public class Tenant extends CSMDataAbstractEntity {
    ...
    @Column(name = "tenant_code", nullable = false, updatable = false, length = 100)
    ...
    @Builder.Default
    private List<OidcIdentityProviderEntity> identityProviders = new ArrayList<>();
}
