-- V2_3__bootstrap_partner_aa.sql
-- Seeds the American Airlines partner aggregate for tenant QR

------------------------------------------------------------
-- Codeshare Partner (AA)
------------------------------------------------------------
WITH tenant_ctx AS (
