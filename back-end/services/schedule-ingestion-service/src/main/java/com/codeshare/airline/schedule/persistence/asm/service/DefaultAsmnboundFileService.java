...
@Transactional
public class DefaultAsmnboundFileService implements AsmInboundFileService {
    ...
    @Override
    public AsmInboundFileDTO create(ScheduleSourceFile sourceFile) {
        ...
        return AsmInboundFileDTO.toDto(ssimInboundFile);
    }
