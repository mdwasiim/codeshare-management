...
public class SsimParsedFile {
    ...
    public static SsimParsedFile toDto(com.codeshare.airline.schedule.persistence.ssim.entity.SsimInboundFile entity) {

        return SsimParsedFile.builder()
    ...
    public static com.codeshare.airline.schedule.persistence.ssim.entity.SsimInboundFile toEntity(SsimParsedFile inboundFileDTO) {

        if (inboundFileDTO == null) {
            return null;
        }

        com.codeshare.airline.schedule.persistence.ssim.entity.SsimInboundFile entity = new com.codeshare.airline.schedule.persistence.ssim.entity.SsimInboundFile();
