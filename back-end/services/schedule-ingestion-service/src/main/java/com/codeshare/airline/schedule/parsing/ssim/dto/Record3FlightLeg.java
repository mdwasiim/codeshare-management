...
public class Record3FlightLeg {
    ...
    public static Record3FlightLeg toDto(SsimInboundFlightLeg entity) {

        if (entity == null) return null;

        return Record3FlightLeg.builder()
                .id(entity.getId())
    ...
    public static SsimInboundFlightLeg toEntity(Record3FlightLeg entity) {
