...
import com.codeshare.airline.schedule.ingestion.orchestration.loader.SsimDatasetStreamLoader;
...
@Component
public class SsimDatasetIngestionPipeline extends GenericIngestionPipeline {

    public SsimDatasetIngestionPipeline(SsimDatasetStreamLoader genericStreamLoader,
