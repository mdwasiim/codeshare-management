...
public class RecordOrderRule implements StructuralValidationRule {
    ...
    private void handleT1(SsimStructuralValidationContext ctx, int lineNumber) {
    ...
    private void handleT2(SsimStructuralValidationContext ctx, int lineNumber) {
    ...
    private void handleT3(SsimStructuralValidationContext ctx, int lineNumber) {
    ...
    private void handleT4(SsimStructuralValidationContext ctx, int lineNumber) {
    ...
    private void handleT5(SsimStructuralValidationContext ctx, int lineNumber) {
