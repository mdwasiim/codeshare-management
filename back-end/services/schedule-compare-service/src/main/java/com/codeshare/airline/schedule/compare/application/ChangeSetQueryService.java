...
public class ChangeSetQueryService {
    ...
    public ChangeSetDTO getChangeSet(UUID changeSetId) {
        ...
        return ChangeSetDTO.builder()
                ...
                .partnerCode(run.getPartnerCode())
                .acceptanceMode(run.getAcceptanceMode())
    ...
    private ScheduleSegmentChangeDTO toSegmentChange(ScheduleSegmentChangeEntity entity) {
        ...
        if (entity.getSegmentChangeType() != com.codeshare.airline.schedule.compare.domain.enums.SegmentChangeType.ADDED) {
        ...
        if (entity.getSegmentChangeType() != com.codeshare.airline.schedule.compare.domain.enums.SegmentChangeType.REMOVED) {
