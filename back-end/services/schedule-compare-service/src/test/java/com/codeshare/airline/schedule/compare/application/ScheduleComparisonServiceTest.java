...
class ScheduleComparisonServiceTest {
    ...
    void compareCreatesNewLegChangeSetForFirstOperationalLoad() {
        ...
        TenantAcceptanceRuleClient tenantAcceptanceRuleClient = mock(TenantAcceptanceRuleClient.class);
        ...
        assertThat(finalRun.getFlightChanges().getFirst().getChangeSetStatus()).isEqualTo(ChangeSetStatus.PENDING);
        assertThat(finalRun.getFlightChanges().getFirst().getLegChanges().getFirst().getChangeType()).isEqualTo(LegChangeType.NEW);
        assertThat(finalRun.getFlightChanges().getFirst().getLegChanges().getFirst().getChangeSetStatus()).isEqualTo(ChangeSetStatus.PENDING);
