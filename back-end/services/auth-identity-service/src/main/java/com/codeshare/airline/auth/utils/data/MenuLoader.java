...
public class MenuLoader {
    ...
    public void load() throws JsonProcessingException {
        for (String t : TENANTS) {
            ...
            getFullMenuJson(tenantId);
        }

    }

    private  void getFullMenuJson(UUID tenantId ) throws JsonProcessingException {
        ...
        for(Menu menus: entities ) {
            System.out.println("+++++ menu  "+menus.toString());
            ...
            System.out.println("+++++ name  "+menus.getName());
            menus.setTenantId(tenantId);
            menus.setTitle(menus.getName());
