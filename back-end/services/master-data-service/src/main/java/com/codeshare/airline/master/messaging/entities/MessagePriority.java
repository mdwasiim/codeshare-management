...
@Entity(name = "Message_Priority")
@Table(
        name = "MESSAGE_PRIORITY",
        uniqueConstraints = {
                @UniqueConstraint(name = "UK_MESSAGE_PRIORITY", columnNames = "PRIORITY_CODE")
        },
        indexes = {
                @Index(name = "IDX_MESSAGE_PRIORITY_STATUS", columnList = "STATUS")
        }
)
@Getter
@Setter
@NoArgsConstructor
public class MessagePriority extends CSMDataAbstractEntity {
