...
@Service
public class ReservationBookingDesignatorServiceImpl extends BaseServiceImpl<ReservationBookingDesignator, ReservationBookingDesignatorDTO, Long> implements ReservationBookingDesignatorService {
