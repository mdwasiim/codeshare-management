...
@Setter
@NoArgsConstructor
public class Airline extends CSMDataAbstractEntity {
     ...
     * EK
     */
    @Column(name = "IATA_DESIGNATOR", nullable = false, length = 2)
    ...
    private void validateAndNormalize() {
        ...
        if (iataDesignator == null || iataDesignator.isBlank()) {
        ...
        iataDesignator = iataDesignator.trim().toUpperCase();
