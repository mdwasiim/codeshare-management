...
@Table(
        ...
        uniqueConstraints = {
                ...
                @UniqueConstraint(
                        name = "UK_CABIN_CREW_EMPLOYER_NAME",
                        columnNames = "EMPLOYER_NAME"
                )
        },
        indexes = {
                @Index(
                        name = "IDX_CABIN_CREW_EMPLOYER_CODE",
                        columnList = "EMPLOYER_CODE"
                ),
                @Index(
                        name = "IDX_CABIN_CREW_EMPLOYER_NAME",
                ...
                @Index(
                        name = "IDX_CABIN_CREW_EMPLOYER_COUNTRY",
...
@Setter
@NoArgsConstructor
public class CabinCrewEmployer extends CSMMasterDataEntity {
