...
public enum CSMErrorCodes {
    ...
    AUTH_INVALID_CREDENTIALS(808101, "AUTH_401", "Invalid username or password"),
    AUTH_USER_LOCKED(808102, "AUTH_423", "User account is locked"),
    AUTH_TENANT_NOT_FOUND(808103, "AUTH_403", "Tenant configuration not found"),
    AUTH_REFRESH_TOKEN_INVALID(808104, "AUTH_401_REFRESH", "Refresh token invalid"),
    AUTH_FLOW_NOT_SUPPORTED(808105, "AUTH_400_FLOW", "Authentication flow not supported");
