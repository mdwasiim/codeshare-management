...
import { GroupFormPage } from '@features/access-management/identity/groups/pages/group-form/group-form.page';
...
export class GroupListPage extends BaseListComponent<Group> {
    ...
    deleteSelectedGroups() {
        ...
        this.confirm.delete('Delete selected groups?', () => {
            const requests = this.selectedGroups.map((g) => this.service.delete(g.id!));
    ...
    deleteGroup(group: Group) {
        this.confirm.delete(`Delete group "${group.name}"?`, () => {
